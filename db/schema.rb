...
ActiveRecord::Schema[7.0].define(version: 2023_05_01_100749) do
  ...
  create_table "temp_week_days", force: :cascade do |t|
    ...
    t.string "state", null: false
    t.datetime "apertura", precision: nil, null: false
    t.datetime "chiusura", precision: nil, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
